...
insert into empleado(nro,nombre,cod_esp,nro_jefe,sueldo,f_ingreso) values
(5,"Jeremias",2,1000,5000,"2000-04-12");
insert into empleado(nro,nombre,cod_esp,nro_jefe,sueldo,f_ingreso) values
(6,"Alejandra",2,1000,3000,"1990-04-12");
insert into empleado(nro,nombre,cod_esp,nro_jefe,sueldo,f_ingreso) values
(8,"Armando",2,1000,3000,"1990-04-12");
insert into empleado(nro,nombre,cod_esp,nro_jefe,sueldo,f_ingreso) values
(9,"Luana",2,1000,3000,"1990-04-12");

insert into empleado(nro,nombre,cod_esp,sueldo,f_ingreso) 
values(1000,"Juan",1,10000,"2000-01-01");
